...
import { File, ChevronDown, FileText, Mic, ArrowUp, X, PanelRightClose, PanelRightOpen, Minimize2, Maximize2, Loader2, MoreVertical, Pin, PinOff, Trash2, History } from 'lucide-react';
            ...
            {isFirstTime ? (
              ...
              <div className="flex-1 flex items-center justify-center py-4 relative">
                ...
                <button
                  ...
                  title="Go to chat view with history"
                >
